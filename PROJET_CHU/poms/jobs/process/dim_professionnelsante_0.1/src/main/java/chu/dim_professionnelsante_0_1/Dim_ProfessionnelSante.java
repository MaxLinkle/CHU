	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "profession", });
...
///////////////////////    			
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/Dim_ProfessionnelSante/Dim_ProfessionnelSante.txt");
				...
				String dbquery_tDBInput_1 = "Select  \"Profession\" as \"profession\" from public.\"Professionnel_de_sante\"";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.profession = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
...
//////////
						...
						if (row3.profession == null) {
							finder_tUniqRow_1.profession = null;
						} else {
							finder_tUniqRow_1.profession = row3.profession.toLowerCase();
						}
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							if (row3.profession == null) {
								new_tUniqRow_1.profession = null;
							} else {
								new_tUniqRow_1.profession = row3.profession.toLowerCase();
							}
							...
							row4.profession = row3.profession;
...
///////////////////////		
							...
							if (row5.profession != null) { //
								row_tLogRow_1[0] = String.valueOf(row5.profession);
...
// # Output table : 'profession_file'
								profession_file_tmp.profession = row2.profession;
...
// for output
								...
								row3.profession = profession_file.profession;
...
/************************************************************************************************
 * 117230 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 13:05:21 CEST
 ************************************************************************************************/