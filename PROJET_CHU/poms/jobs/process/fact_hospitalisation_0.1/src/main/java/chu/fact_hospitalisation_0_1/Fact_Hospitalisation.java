...
///////////////////////    			
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/Fact_Hospitalisation/Fact_Hospitalisation.txt");
...
///////////////////////		
							...
							if (row4.Num_Hospitalisation != null) { //
								row_tLogRow_1[0] = String.valueOf(row4.Num_Hospitalisation);

							} //

							if (row4.Id_patient != null) { //
								row_tLogRow_1[1] = String.valueOf(row4.Id_patient);

							} //

							if (row4.Code_diagnostic != null) { //
								row_tLogRow_1[2] = String.valueOf(row4.Code_diagnostic);
...
/************************************************************************************************
 * 92211 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 08:39:01 CEST
 ************************************************************************************************/