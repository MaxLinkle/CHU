...
// # Output table : 'Visite'
								...
								Visite_tmp.Date_Entree = row1.Date_Entree;
								Visite_tmp.Jour_Hospitalisation = row1.Jour_Hospitalisation;
								Visite = Visite_tmp;
// ###############################
...
// Start of branch "Visite"
							if (Visite != null) {
								...
								if (Visite.Jour_Hospitalisation != null) {

									sb_tHDFSOutput_1.append(

											Visite.Jour_Hospitalisation
...
///////////////////////		
								...
								if (row2.Date_Entree != null) { //
									row_tLogRow_1[1] = String.valueOf(row2.Date_Entree);

								} //

								if (row2.Jour_Hospitalisation != null) { //
									row_tLogRow_1[2] = String.valueOf(row2.Jour_Hospitalisation);
...
/************************************************************************************************
 * 88637 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 10:38:58 CEST
 ************************************************************************************************/