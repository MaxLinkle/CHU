...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Dim_Visite/Dim_Visite.txt");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Visite.class.getClassLoader().getResourceAsStream("chu/dim_visite_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Visite.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     76012 characters generated by Talend Open Studio for Big Data 
