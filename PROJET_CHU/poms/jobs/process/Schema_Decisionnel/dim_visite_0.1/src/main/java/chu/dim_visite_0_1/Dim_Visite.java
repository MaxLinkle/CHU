 ...
 * @status
 */
public class Dim_Visite implements TalendJob {
	...
	private final String jobName = "Dim_Visite";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Visite.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class VisiteStruct implements routines.system.IPersistableRow<VisiteStruct> {
		final static byte[] commonByteArrayLock_CHU_Dim_Visite = new byte[0];
		static byte[] commonByteArray_CHU_Dim_Visite = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CHU_Dim_Visite.length) {
					if (length < 1024 && commonByteArray_CHU_Dim_Visite.length == 0) {
						commonByteArray_CHU_Dim_Visite = new byte[1024];
					} else {
						commonByteArray_CHU_Dim_Visite = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CHU_Dim_Visite, 0, length);
				strReturn = new String(commonByteArray_CHU_Dim_Visite, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CHU_Dim_Visite) {
				...
				try {
					...
					this.Date_Visite = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Date_Visite, dos);
		...
		public String toString() {
			...
			sb.append(",Date_Visite=" + Date_Visite);
		 ...
		 * Compare keys
		 */
		public int compareTo(VisiteStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				VisiteStruct Visite = new VisiteStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Visite");
				}
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/CHU/Dim_Visite/Dim_Visite.txt");
...
// # Vars initialization
				class Var__tMap_1__Struct {
					String TrimDateHospitalisation;
				}
...
// # Outputs initialization
				VisiteStruct Visite_tmp = new VisiteStruct();
// ###############################
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.TrimDateHospitalisation = StringHandling.RIGHT(row1.Date_Entree, 4) + "-"
										+ StringHandling.RIGHT(StringHandling.LEFT(row1.Date_Entree, 5), 2) + "-"
										+ StringHandling.LEFT(row1.Date_Entree, 2);// ###############################
								// ###############################
								// # Output tables
...
// # Output table : 'Visite'
								Visite_tmp.Num_Hospitalisation = row1.Num_Hospitalisation;
								Visite_tmp.Date_Visite = Var.TrimDateHospitalisation;
								Visite_tmp.Nb_Jours = row1.Jour_Hospitalisation;
								Visite = Visite_tmp;
// ###############################
...
// Start of branch "Visite"
							if (Visite != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "Visite");
								}

								StringBuilder sb_tHDFSOutput_1 = new StringBuilder();

								if (Visite.Num_Hospitalisation != null) {

									sb_tHDFSOutput_1.append(

											Visite.Num_Hospitalisation
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Visite");
				}
	...
	public static void main(String[] args) {
		final Dim_Visite Dim_VisiteClass = new Dim_Visite();

		int exitCode = Dim_VisiteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Visite.class.getClassLoader()
					.getResourceAsStream("chu/dim_visite_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Visite.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Visite");
		}
...
/************************************************************************************************
 * 76122 characters generated by Talend Open Studio for Big Data on the 16 mai
 * 2022 23:43:06 CEST
 ************************************************************************************************/