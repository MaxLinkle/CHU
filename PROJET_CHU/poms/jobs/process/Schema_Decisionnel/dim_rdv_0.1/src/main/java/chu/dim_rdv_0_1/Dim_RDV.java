...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tHDFSConnection_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tHadoopConfManager_tHDFSConnection_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tHDFSConnection_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tHadoopConfManager_tHDFSConnection_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
		...
		int tos_count_tDBConnection_2 = 0;
            ...
            String url_tDBConnection_2 = "jdbc:postgresql://"+context.PostgresSQL_Server+":"+context.PostgresSQL_Port+"/"+context.PostgresSQL_Database;
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tHDFSConnection_2:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Dim_RDV/Dim_RDV.txt");
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.PostgresSQL_Password; 
				...
				String url_tDBInput_2 = "jdbc:postgresql://" + context.PostgresSQL_Server + ":" + context.PostgresSQL_Port + "/" + context.PostgresSQL_Database + "?" + context.PostgresSQL_AdditionalParams;
...
public void tHadoopConfManager_tHDFSConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
...
String confJarName = dealJobLibrary.getConfJarName("hadoop-conf-CHU_Cluster.jar", this.contextStr);
    ...
    libPath_tHadoopConfManager_tHDFSConnection_2 = new java.io.File("C:/TOS_BD-20200219_1130-V7.3.1/workspace/CHU/temp/lib/" + confJarName).getAbsolutePath();
libPath_tHadoopConfManager_tHDFSConnection_2 = dealJobLibrary.replaceJarPathsFromCrcMap(libPath_tHadoopConfManager_tHDFSConnection_2);

java.net.URLClassLoader currentLoadertHadoopConfManager_tHDFSConnection_2 = (java.net.URLClassLoader) Thread.currentThread().getContextClassLoader();
java.lang.reflect.Method method_tHadoopConfManager_tHDFSConnection_2 = java.net.URLClassLoader.class.getDeclaredMethod("addURL", new Class[] { java.net.URL.class });
method_tHadoopConfManager_tHDFSConnection_2.setAccessible(true);
method_tHadoopConfManager_tHDFSConnection_2.invoke(currentLoadertHadoopConfManager_tHDFSConnection_2, new Object[] { new java.io.File(libPath_tHadoopConfManager_tHDFSConnection_2).toURL() });
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_RDV.class.getClassLoader().getResourceAsStream("chu/dim_rdv_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_RDV.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;tHadoopConfManager_tHDFSConnection_2Process(globalMap);
...
/************************************************************************************************
 *     73290 characters generated by Talend Open Studio for Big Data 
