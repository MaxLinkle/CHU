...
// # Output table : 'deces'
								deces_tmp.region = StringHandling.UPCASE(StringHandling
										.CHANGE(TalendString.removeAccents(row2.Nom_Actuel_Region_Deces), "-", " "));
								deces = deces_tmp;
// ###############################
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row5,row1) outputs:(etablissement)
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row5.complement_destinataire = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row5.complement_point_geographique = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row5.enseigne_commerciale_site = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							row5.finess_etablissement_juridique = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row5.identifiant_organisation = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 12;

							row5.indice_repetition_voie = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 13;

							row5.mention_distribution = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row5.raison_sociale_site = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/CHU/Fact_Satisfaction/Fact_Satisfaction.txt");
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.score_all_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									// row5.finess_etablissement_juridique = '" +
									// row5HashKey.finess_etablissement_juridique + "'");
								} // G 071
								...
								{ // start of Var scope
									...
									Var.var2 = StringHandling.UPCASE(
											StringHandling.CHANGE(TalendString.removeAccents(Var.var1), "-", " "));// ###############################
									// ###############################
									// # Output tables
...
// Start of branch "etablissement"
								if (etablissement != null) {
									...
									if (etablissement.identifiant_organisation == null) {
										...
										finder_tUniqRow_2.identifiant_organisation = etablissement.identifiant_organisation
												.toLowerCase();
									}
									...
									if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
										...
										if (etablissement.identifiant_organisation == null) {
											...
											new_tUniqRow_2.identifiant_organisation = etablissement.identifiant_organisation
													.toLowerCase();
										}
										...
										row8.identifiant_organisation = etablissement.identifiant_organisation;
										row8.region = etablissement.region;
...
// Start of branch "row8"
									if (row8 != null) {
										...
										if (tHash_Lookup_region != null
												&& tHash_Lookup_region.getCount(regionHashKey) > 1) { // G 071
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Satisfaction.class.getClassLoader()
					.getResourceAsStream("chu/fact_satisfaction_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Fact_Satisfaction.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fact_Satisfaction");
		}
