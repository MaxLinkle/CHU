...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Dim_ProfessionnelSante/Dim_ProfessionnelSante.txt");
...
if(row3.Identifiant == null){
	...
	row4 = new row4Struct();
}row4.Identifiant = row3.Identifiant;			row4.Nom = row3.Nom;			row4.Prenom = row3.Prenom;					
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/Administrateur.WIN-T87HKARVT4F/Documents/Bdd_Gestion_des_professionnels/professionnel_sante.csv", "US-ASCII",";","\n",false,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row2.categorie_professionnelle = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
							...
							row2.type_identifiant = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_ProfessionnelSante.class.getClassLoader().getResourceAsStream("chu/dim_professionnelsante_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_ProfessionnelSante.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_ProfessionnelSante");
        }
...
/************************************************************************************************
 *     109550 characters generated by Talend Open Studio for Big Data 
 *     on the 12 mai 2022 13:42:17 CEST
 ************************************************************************************************/