...
public class Fact_Deces implements TalendJob {
	...
	public void tAdvancedHash_region_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		...
		public String toString() {
			...
			sb.append(",NbDeces=" + String.valueOf(NbDeces));
			sb.append("]");
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.IDRegion == null) ? 0 : this.IDRegion.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.IDRegion == null) {
							if (other.IDRegion != null)
								return false;
						} else if (!this.IDRegion.equals(other.IDRegion))
							return false;
...
// # Lookup's keys initialization
				...
				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<regionStruct> tHash_Lookup_region = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<regionStruct>) ((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<regionStruct>) globalMap
						.get("tHash_Lookup_region"));
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Date_Naissance", "row4", temp, ex_tFileInputDelimited_2),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Date_Deces", "row4", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row4.Pays_Source_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row4.Code_Source_Commune_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							row4.Nom_Source_Commune_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 8;

							row4.Code_Actuel_Commune_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							row4.Nom_Actuel_Commune_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 10;

							row4.Code_Actuel_Departement_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 11;

							row4.Nom_Actuel_Departement_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 12;

							row4.Code_Actuel_Region_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 13;

							row4.Nom_Actuel_Region_Naissance = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 14;

							row4.Code_Source_Commune_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 15;

							row4.Code_Actuel_Commune_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 16;

							row4.Nom_Actuel_Commune_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 17;

							row4.Code_Actuel_Departement_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 18;

							row4.Nom_Actuel_Departement_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 19;

							row4.Code_Actuel_Region_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 20;

							row4.Nom_Actuel_Region_Deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 21;

							row4.Numero_d_acte_du_deces = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 22;

							row4.Nom_du_fichier_source_INSEE = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row4"
						if (row4 != null) {
							...
							{ // start of Var scope
								...
								Var.TrimRegion = StringHandling.UPCASE(StringHandling
										.CHANGE(TalendString.removeAccents(row4.Nom_Actuel_Region_Deces), "-", " "));// ###############################
								// ###############################
								// # Output tables
...
// # Output table : 'acte'
								acte_tmp.Nom_Actuel_Region_Deces = Var.TrimRegion;
								acte = acte_tmp;
// ###############################
...
// Start of branch "acte"
							if (acte != null) {
								...
								if (tHash_Lookup_region != null && tHash_Lookup_region.getCount(regionHashKey) > 1) { // G
																														// 071

									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
									// 'region' and it contains more one result from keys : region.region = '" +
									// regionHashKey.region + "'");
								} // G 071
...
// Start of branch "res"
								if (res != null) {
									...
									operation_finder_tAggregateRow_1.IDRegion = res.IDRegion;
									...
									if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
										...
										operation_result_tAggregateRow_1.IDRegion = operation_finder_tAggregateRow_1.IDRegion;
									...
									operation_result_tAggregateRow_1.NbDeces_clmCount++;
...
// ###############################      
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/CHU/Fact_Deces/Fact_Deces.txt");
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row6.IDRegion = aggregated_row_tAggregateRow_1.IDRegion;
					row6.NbDeces = (int) aggregated_row_tAggregateRow_1.count;
					row6.NbDeces = (int) aggregated_row_tAggregateRow_1.NbDeces_clmCount;
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:hz9xWnLmyUxu5qfYXoWNCsjjdxn+BLFZeQNtZQ==");
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_all_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_all_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_accueil_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
											.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1],
													null, '.' == decimalChar_tFileInputExcel_1 ? null
															: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_accueil_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_PECinf_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
											.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1],
													null, '.' == decimalChar_tFileInputExcel_1 ? null
															: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_PECinf_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_PECmed_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
											.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1],
													null, '.' == decimalChar_tFileInputExcel_1 ? null
															: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_PECmed_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_chambre_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
											.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1],
													null, '.' == decimalChar_tFileInputExcel_1 ? null
															: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_chambre_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_repas_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
											.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1],
													null, '.' == decimalChar_tFileInputExcel_1 ? null
															: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_repas_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_rep_score_sortie_rea_ajust = ParserUtils.parseTo_Integer(ParserUtils
											.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1],
													null, '.' == decimalChar_tFileInputExcel_1 ? null
															: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.score_sortie_rea_ajust = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row2.nb_reco_brut = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
...
// # Filter conditions 
									...
									(Relational.NOT(Relational.ISNULL(row2.region))
											&& "PACA".equals(row2.region) == false)

									) {
										satisfaction_tmp.region = StringHandling.UPCASE(StringHandling
												.CHANGE(TalendString.removeAccents(row2.region), "-", " "));
...
// Start of branch "row5"
									if (row5 != null) {
										...
										arrayRowtSortRow_1_SortOut.region = row5.region;
...
// # Filter conditions 
								...
								(row1.Nom_Actuel_Region_Deces.equals("") == false)

								) {
									deces_tmp.region = StringHandling.UPCASE(StringHandling.CHANGE(
											TalendString.removeAccents(row1.Nom_Actuel_Region_Deces), "-", " "));
									deces = deces_tmp;
								} // closing filter/reject
// ###############################
...
// ###############################      
				...
				// linked node: tMap_5 - inputs:(region,acte) outputs:(res)
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Deces.class.getClassLoader()
					.getResourceAsStream("chu/fact_deces_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Fact_Deces.class.getClassLoader()
...
/************************************************************************************************
 * 241757 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 11:53:30 CEST
 ************************************************************************************************/