...
public class Dim_Patient implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/CHU/Dim_Patient/Dim_Patient.txt");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Patient.class.getClassLoader()
					.getResourceAsStream("chu/dim_patient_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Patient.class.getClassLoader()
...
/************************************************************************************************
 * 73441 characters generated by Talend Open Studio for Big Data on the 13 mai
 * 2022 13:30:55 CEST
 ************************************************************************************************/