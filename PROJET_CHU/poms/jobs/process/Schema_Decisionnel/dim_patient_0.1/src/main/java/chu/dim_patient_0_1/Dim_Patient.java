...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_CHU_Dim_Patient = new byte[0];
    static byte[] commonByteArray_CHU_Dim_Patient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHU_Dim_Patient.length) {
				if(length < 1024 && commonByteArray_CHU_Dim_Patient.length == 0) {
   					commonByteArray_CHU_Dim_Patient = new byte[1024];
				} else {
   					commonByteArray_CHU_Dim_Patient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHU_Dim_Patient, 0, length);
			strReturn = new String(commonByteArray_CHU_Dim_Patient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHU_Dim_Patient) {
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Dim_Patient/Dim_Patient.txt");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.PostgresSQL_Password; 
		    ...
		    String dbquery_tDBInput_1 =  "SELECT \"Id_patient\", \"Sexe\", \"Age\" FROM public.\"Patient\"";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Patient.class.getClassLoader().getResourceAsStream("chu/dim_patient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     73441 characters generated by Talend Open Studio for Big Data 
