...
public class Dim_Diagnostic implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/CHU/Dim_Diagnostic/Dim_Diagnostic.txt");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Diagnostic.class.getClassLoader()
					.getResourceAsStream("chu/dim_diagnostic_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Diagnostic.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Diagnostic");
		}
...
/************************************************************************************************
 * 72242 characters generated by Talend Open Studio for Big Data on the 13 mai
 * 2022 13:36:56 CEST
 ************************************************************************************************/