...
package chu.dim_diagnostic_0_1;
...
/**
 * Job: Dim_Diagnostic Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Dim_Diagnostic implements TalendJob {
...
public String getHDFS_Cluster_hadoopConfSpecificJar(){
	...
	private final String jobName = "Dim_Diagnostic";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Diagnostic.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Diagnostic.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_CHU_Dim_Diagnostic = new byte[0];
    static byte[] commonByteArray_CHU_Dim_Diagnostic = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHU_Dim_Diagnostic.length) {
				if(length < 1024 && commonByteArray_CHU_Dim_Diagnostic.length == 0) {
   					commonByteArray_CHU_Dim_Diagnostic = new byte[1024];
				} else {
   					commonByteArray_CHU_Dim_Diagnostic = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHU_Dim_Diagnostic, 0, length);
			strReturn = new String(commonByteArray_CHU_Dim_Diagnostic, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHU_Dim_Diagnostic) {
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Dim_Diagnostic/Dim_Diagnostic.txt");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.PostgresSQL_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM public.\"Diagnostic\"";
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Diagnostic Dim_DiagnosticClass = new Dim_Diagnostic();

        int exitCode = Dim_DiagnosticClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Diagnostic.class.getClassLoader().getResourceAsStream("chu/dim_diagnostic_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Diagnostic.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Diagnostic");
        }
...
/************************************************************************************************
 *     72242 characters generated by Talend Open Studio for Big Data 
 *     on the 12 mai 2022 13:42:15 CEST
 ************************************************************************************************/