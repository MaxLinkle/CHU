		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						"/user/cloudera/CHU/Dim_Etablissement/Dim_Etablissement.txt");
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.complement_destinataire = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.complement_point_geographique = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.enseigne_commerciale_site = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							row1.finess_etablissement_juridique = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.identifiant_organisation = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							row1.indice_repetition_voie = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 13;

							row1.mention_distribution = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.raison_sociale_site = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row2.finess = '" +
								// row2HashKey.finess + "'");
							} // G 071
...
// # Output table : 'etablissement'
								etablissement_tmp.id_organisation = row1.identifiant_organisation;
...
// Start of branch "etablissement"
							if (etablissement != null) {
								...
								if (etablissement.id_organisation != null) {

									sb_tHDFSOutput_1.append(

											etablissement.id_organisation
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:rK3971Vf7nZB4IBGvqa/mI8IlVaeKEycvKjpvg==");
...
// Start of branch "row2"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Etablissement.class.getClassLoader()
					.getResourceAsStream("chu/dim_etablissement_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Etablissement.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Etablissement");
		}
...
/************************************************************************************************
 * 140855 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 15:22:42 CEST
 ************************************************************************************************/