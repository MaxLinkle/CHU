...
package chu.dim_etablissement_0_1;
...
/**
 * Job: Dim_Etablissement Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Dim_Etablissement implements TalendJob {
...
public String getHDFS_Cluster_NameNodeUri(){
	...
	private final String jobName = "Dim_Etablissement";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Etablissement.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Etablissement.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class etablissementStruct implements routines.system.IPersistableRow<etablissementStruct> {
    final static byte[] commonByteArrayLock_CHU_Dim_Etablissement = new byte[0];
    static byte[] commonByteArray_CHU_Dim_Etablissement = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHU_Dim_Etablissement.length) {
				if(length < 1024 && commonByteArray_CHU_Dim_Etablissement.length == 0) {
   					commonByteArray_CHU_Dim_Etablissement = new byte[1024];
				} else {
   					commonByteArray_CHU_Dim_Etablissement = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHU_Dim_Etablissement, 0, length);
			strReturn = new String(commonByteArray_CHU_Dim_Etablissement, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHU_Dim_Etablissement) {
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Dim_Etablissement/Dim_Etablissement.txt");
...
etablissement_tmp.identifiant_organisation = row1.identifiant_organisation ;
etablissement_tmp.cedex = row1.cedex ;
etablissement_tmp.score_all_rea_ajust = row2.score_all_rea_ajust ;
					...
					StringBuilder sb_tHDFSOutput_1 = new StringBuilder();
								...
								if(etablissement.identifiant_organisation != null) {
									...
									sb_tHDFSOutput_1.append(
											...
											etablissement.identifiant_organisation
								...
								if(etablissement.score_all_rea_ajust != null) {
							
									sb_tHDFSOutput_1.append(
										
											etablissement.score_all_rea_ajust
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(etablissement)
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZhOWqNc5n0QVxWhqVWZH21kK14eDJB+JeMaoBw==");
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Etablissement Dim_EtablissementClass = new Dim_Etablissement();

        int exitCode = Dim_EtablissementClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Etablissement.class.getClassLoader().getResourceAsStream("chu/dim_etablissement_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Etablissement.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Etablissement");
        }
...
/************************************************************************************************
 *     140945 characters generated by Talend Open Studio for Big Data 
 *     on the 12 mai 2022 13:42:16 CEST
 ************************************************************************************************/