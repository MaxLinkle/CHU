...
package chu.fact_consultation_0_1;
...
/**
 * Job: Fact_Consultation Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Fact_Consultation implements TalendJob {
...
public String getHDFS_Cluster_hadoopConfSpecificJar(){
	...
	private final String jobName = "Fact_Consultation";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Fact_Consultation.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Fact_Consultation.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class consultationStruct implements routines.system.IPersistableRow<consultationStruct> {
     ...
     * Compare keys
     */
    public int compareTo(consultationStruct other) {
...
consultationStruct consultation = new consultationStruct();
	...
	currentComponent="tHDFSOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"consultation");
					}
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path("/user/cloudera/CHU/Fact_Consultation/Fact_Consultation.txt");
...
consultationStruct consultation_tmp = new consultationStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.PostgresSQL_Password; 
				...
				String url_tDBInput_1 = "jdbc:postgresql://" + context.PostgresSQL_Server + ":" + context.PostgresSQL_Port + "/" + context.PostgresSQL_Database + "?" + context.PostgresSQL_AdditionalParams;
		    ...
		    String dbquery_tDBInput_1 = "Select \"Num_consultation\", \"Id_patient\", \"Code_diag\", \"Id_prof_sante\" From public.\"Consultation\"";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row7.Num_consultation = 0;
							} else {
		                          
            row7.Num_consultation = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row7.Id_patient = null;
							} else {
		                          
            row7.Id_patient = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    row7.Id_patient = null;
            }
		                    }
        	...
        	row7.Code_diag = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row7.Id_prof_sante = null;
							} else {
	                         		
        	row7.Id_prof_sante = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
 					    ...
 					    boolean forceLooprow1 = false;
 							...
 							row1Struct row1ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row1HashKey.identifiant = row7.Id_prof_sante ;
...
if(consultation != null) { 
	...
	currentComponent="tHDFSOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"consultation");
					}
					...
					StringBuilder sb_tHDFSOutput_1 = new StringBuilder();
									...
									sb_tHDFSOutput_1.append(
											...
											consultation.Num_consultation
										
									);
												
								sb_tHDFSOutput_1.append(";");
							
								if(consultation.Id_patient != null) {
	...
	currentComponent="tHDFSOutput_1";
		...
		if(outtHDFSOutput_1!=null){
			outtHDFSOutput_1.close();
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"consultation");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row1";
		...
		int tos_count_tAdvancedHash_row1 = 0;
			   		...
			   		// source node:tFileInputDelimited_3 - inputs:(after_tDBInput_1) outputs:(row1,row1) | target node:tAdvancedHash_row1 - inputs:(row1) outputs:()
			   		// linked node: tMap_3 - inputs:(row7,row1) outputs:(consultation)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_3 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_3 = "C:/Users/Administrateur.WIN-T87HKARVT4F/Documents/Bdd_Gestion_des_professionnels/activite_professionnel_sante.csv";
			...
			if(footer_value_tFileInputDelimited_3 >0 || random_value_tFileInputDelimited_3 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited("C:/Users/Administrateur.WIN-T87HKARVT4F/Documents/Bdd_Gestion_des_professionnels/activite_professionnel_sante.csv", "UTF-8",";","\n",false,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_3 = 0;
					...
					columnIndexWithD_tFileInputDelimited_3 = 0;
							...
							row1.identifiant = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 1;
					
							row1.identifiant_organisation = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 2;
					
							row1.mode_exercice = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
if(row1 != null) { 
	...
	currentComponent="tAdvancedHash_row1";
				...
				row1_HashRow.identifiant_organisation = row1.identifiant_organisation;
				
				row1_HashRow.mode_exercice = row1.mode_exercice;
 ...
 */
    ...
    public static void main(String[] args){
        final Fact_Consultation Fact_ConsultationClass = new Fact_Consultation();

        int exitCode = Fact_ConsultationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fact_Consultation.class.getClassLoader().getResourceAsStream("chu/fact_consultation_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Fact_Consultation.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                ...
                private void processContext_0() {
                        ...
                        context.setContextType("PostgresSQL_Password", "id_Password");
                            ...
                            if(pwd_PostgresSQL_Password_value!=null) {
                                if(context_param.containsKey("PostgresSQL_Password")) {//no need to decrypt if it come from program argument or parent job runtime
                                    context.PostgresSQL_Password = pwd_PostgresSQL_Password_value;
                                } else if (!pwd_PostgresSQL_Password_value.isEmpty()) {
                                    try {
                                        context.PostgresSQL_Password = routines.system.PasswordEncryptUtil.decryptPassword(pwd_PostgresSQL_Password_value);
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("PostgresSQL_Schema")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fact_Consultation");
        }
...
/************************************************************************************************
 *     97623 characters generated by Talend Open Studio for Big Data 
 *     on the 12 mai 2022 13:42:19 CEST
 ************************************************************************************************/